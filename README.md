...
| **`crew/`** | **The drop-in agent studio, v2** — copy its contents to the game repo root. 12 agents (7 builders, 2 reviewers, 3 curators — each with ROUTING/I-O/KICKOFF sections), **law-enforcement hooks** (owner-path + banned-API blocks at tool-call time), the [rulings ledger](crew/docs/DESIGN-RULINGS.md), the [crew map](crew/docs/CREW_MAP.md) (diagrams + invocation matrix), 4 skills (game-lead · tickets · **gas-purity** · **ue-editor**), 6 contracts, and the executable board: [tickets BP00–BP14](crew/docs/tickets/), including [BP13](crew/docs/tickets/TICKET_BP13_DATA_CREW.md) — the data crew that **has run** — and [BP08](crew/docs/tickets/TICKET_BP08_BOTS.md) recut for the three-layer bot brain. Start here: [`crew/README.md`](crew/README.md) |
