...
| Path | What it is |
|---|---|
| **`breachpoint/`** | **The active project.** [Vertical-slice GDD](breachpoint/BREACHPOINT-GDD-VERTICAL-SLICE.md) (the six-week build) · [full-concept GDD](breachpoint/BREACHPOINT-GDD-FULL-CONCEPT.md) (Phase-2 target) · [Architecture](breachpoint/BREACHPOINT-ARCHITECTURE.md) (44 class-units, file-by-file) · [Bot AI](breachpoint/BREACHPOINT-AI-BOTS.md) (**GOAP ambitions → StateTree spine → GAS hand** — the Halo-researched three-layer brain) · [Roadmap](breachpoint/BREACHPOINT-ROADMAP.md) (six pods, six milestones) · [Quality Bars](breachpoint/BREACHPOINT-QUALITY-BARS.md) (budgets, DoD, playtest protocol, ship checklist) |
| **`crew/`** | **The drop-in agent studio, v2** — copy its contents to the game repo root. 11 agents (7 builders, 2 reviewers, 2 curators — each with ROUTING/I-O/KICKOFF sections), **law-enforcement hooks** (owner-path + banned-API blocks at tool-call time), the [rulings ledger](crew/docs/DESIGN-RULINGS.md), the [crew map](crew/docs/CREW_MAP.md) (diagrams + invocation matrix), 2 skills, 6 contracts, and the executable board: [tickets BP00–BP14](crew/docs/tickets/), including [BP13](crew/docs/tickets/TICKET_BP13_DATA_CREW.md) — the data crew that **has run** — and [BP08](crew/docs/tickets/TICKET_BP08_BOTS.md) recut for the three-layer bot brain. Start here: [`crew/README.md`](crew/README.md) |
