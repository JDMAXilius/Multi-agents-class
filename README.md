...
| **`docs/method/`** | The crew methodology — [engineering disciplines D1–D8](docs/method/ENGINEERING-DISCIPLINES.md) · [crew roster & agent kinds](docs/method/CREW-ROSTER.md) · [researched best-practice validation](docs/method/ARCHITECTURE-VALIDATION.md) |
