 ...
 *
 * The verb list is the seam-audit's proven set: the eight actions the host game's input
 * path actually accepts from a bot today (25 Aug audit — fire, jump, crouch, sprint,
 * melee, grenade, reload, weapon-next). A verb with no game mapping is pressed into
