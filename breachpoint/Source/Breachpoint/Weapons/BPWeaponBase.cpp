...
DEFINE_LOG_CATEGORY_STATIC(LogBPWeapon, Log, All);
...
bool ABPWeaponBase::GetIntVar(FName VarName, int32& OutValue) const
{
...
bool ABPWeaponBase::SetIntVar(FName VarName, int32 Value)
{
	if (const FIntProperty* Prop = FindFProperty<FIntProperty>(GetClass(), VarName))
	{
...
int32 ABPWeaponBase::GetArrayLength(FName VarName) const
{
...
bool ABPWeaponBase::GetByteArrayElement(FName VarName, int32 Index, uint8& OutValue) const
{
...
UObject* ABPWeaponBase::GetObjectVarRaw(FName VarName) const
{
...
USkeletalMeshComponent* ABPWeaponBase::GetWeaponMesh() const
{
...
uint8 ABPWeaponBase::GetCurrentFireMode() const
{
	int32 Index = 0;
...
void ABPWeaponBase::NextFireMode()
{
...
UAnimMontage* ABPWeaponBase::GetFireAnimMontage(uint8 InSkeletalType, bool InAiming) const
{
...
UAnimMontage* ABPWeaponBase::GetReloadBoltAnimMontage(uint8 InSkeletalType, bool InAiming) const
{
	if (InSkeletalType == SkeletalType_UE4)
	{
		return GetObjectVar<UAnimMontage>(
...
uint8 ABPWeaponBase::GetScopeType() const
{
...
void ABPWeaponBase::PlayAnim(UAnimSequenceBase* NewAnimToPlay, bool bLooping)
{
...
void ABPWeaponBase::ResetAttachments()
{
