 ...
 * ---------------------------------------------------
 * `ui-presentation` SKILL Sec 9 and SCREEN-MANIFEST Sec 7.4 both say colour lives in ONE place and
 ...
 *
 * There are no hex literals in this file and there must never be any. COMPONENT-SPECS Sec 0 is
 ...
 * `FLinearColor::Black` plus the five discrete alphas COMPONENT-SPECS Sec 8 measured. Accent
 * colours (event orange, rarity tints, the VISR channels of `ui-presentation` Sec 3) are NOT in
...
/**
 * COMPONENT-SPECS Sec 0 / SCREEN-MANIFEST Sec 7.4: three stroke weights are in use and only three.
...
namespace BRUI
{
	...
	/** COMPONENT-SPECS Sec 0: the three legal stroke weights, in design pixels at the 1280 base. */
