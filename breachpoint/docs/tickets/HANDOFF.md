...
Built by `Tools/gen_ui/wbp_plan.py` + `build_wbp.py`, which gained two capabilities: a
...
**Five textures** generated by `Tools/gen_ui/gen_menurow_art.py` through the committed
