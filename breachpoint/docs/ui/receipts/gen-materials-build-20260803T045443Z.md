# RECEIPT — UI material generator (build) · 2026-08-03T04:54:43.507636+00:00
...
- PASS `wire Color -> ColorA.Input (UNVERIFIED)` — {"returnValue":null}
...
- **FAILED** `MaterialTools.recompile (UNVERIFIED)` — **FAILED** Material failed to compile:
(Node ComponentMask) Not enough components in (__Material_PreshaderBuffer_0: float3) for component mask 0001
...
## Findings
- **high** — MaterialTools.recompile (UNVERIFIED): **FAILED** Material failed to compile:
(Node ComponentMask) Not enough components in (__Material_PreshaderBuffer_0: float3) for component mask 0001
