...
{
	It(TEXT("mirrors the tactic engine's winner exactly — one tactic, one gate"), [this]()
	{
	...
	It(TEXT("never lets the layers cross — a tactic tag opens no ambition branch and vice versa"), [this]()
	{
	...
	It(TEXT("registers Push as the floor: no commit, and it is last in the builder's order"), [this]()
	{
